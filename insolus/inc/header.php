...
<html lang="fr-CH">
    <head>
        <meta charset="utf-8">
        <title>&bull; inSolus | <?php echo $page['title']; ?></title>
        <meta name="description" content="<?php echo $page['description']; ?>">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <?php
        if (isset($page['canonical'])) {
        ?><link rel="canonical" href="https://insolus.com/<?php echo $page['canonical']; ?>" />
        <?php } ?><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/pure/1.0.0/pure-min.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/pure/1.0.0/grids-responsive-min.css">
        <link rel="stylesheet" href="css/insolus.css">
        <?php
        if ($is_internal_page == "yes") {
        ?><style>#topbar.expandMe { transition:none; }</style>
        <?php } ?><link rel="apple-touch-icon" sizes="180x180" href="/favicons/apple-touch-icon.png">
